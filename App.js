...
const App = () => {
  ...
  console.log("Version check",JSON.stringify(VersionCheck.getPlayStoreUrl({ packageName: 'com.saasinjune' })))
    useEffect(() => {
      ...
      useEffect(() => {
        const checkAppVersion = async () => {
          try {
    const latestVersion = Platform.OS === 'ios'? await fetch(`https://itunes.apple.com/in/lookup?bundleId=com.saasinjune`)
                    .then(r => r.json())
                    ...
                    onPress: () => {
                      Linking.openURL(
                        Platform.OS === 'ios'
                          ...
                          : "https://play.google.com/store/apps/details?id=com.saasinjune"
                      );
                    },
                  },
                ],
